...
export default function Header() {
  ...
  return (
    <header className=" mb-8 bg-white h-16 border-b border-gray-primary">
            ...
            {user ? (
              <>
                <Link to={ROUTES.DASHBOARD} aria-label="Dashboard">
                  <svg
                    className="text-black-light cursor-pointer mr-6 w-8  "
                ...
                <div className="flex items-center cursor-pointer">
                  <Link to={`/p/${user.displayName}`}>
                    <img
                      src={process.env.PUBLIC_URL + `/images/avatars/karl.jpg`}
              ...
              <>
                <Link to={ROUTES.LOGIN}>
                  <button
                    type="button"
                    className="bg-blue-medium text-white font-bold tex-sm rounded w-20 h-8"
                  >
                    Log In
                  </button>
                </Link>
                <Link to={ROUTES.SIGN_UP}>
                  <button
                    type="button"
                    className="text-blue-medium text-white font-bold tex-sm rounded w-20 h-8"
                  >
                    Sign Up
                  </button>
                </Link>
